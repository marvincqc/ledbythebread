      ...
      <section className="mb-10 text-center">
        ...
        <div className="flex items-center justify-center gap-4">
          {!user && (
            <Link
              to="/login"
              className="flex items-center gap-2 bg-white border border-primary/20 hover:border-primary/50 hover:bg-primary/5 text-text-muted hover:text-primary text-sm font-medium px-4 py-2 rounded-button transition-all"
            >
